from interface.chunker import AddHeaderTransformChunk, RecursiveCharacterTextSplitterChunker


class TestRecursiveCharacterTextSplitterChunker:

    def test_chunk(self):
        chunker = RecursiveCharacterTextSplitterChunker(
            chunk_size=4,
            chunk_overlap=2
        )
